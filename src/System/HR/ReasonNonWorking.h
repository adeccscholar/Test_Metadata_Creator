...
* Date: 22.04.2025 22:26:56,464  file created with adecc Scholar metadata generator
...
class TReasonNonWorking : virtual public myCorporate::TSimplePersonBase {
   ...
   public:
      ...
      class primary_key {
         ...
         public:
            ...
            explicit primary_key(TReasonNonWorking const& other);
      ...
      using func_ty = std::function<bool(TReasonNonWorking&&)>;
   ...
   public:
      ...
      explicit TReasonNonWorking(primary_key const&);
