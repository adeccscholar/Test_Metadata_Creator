...
* Date: 14.03.2024 23:56:53,945  file created with adecc Scholar metadata generator
...
// - doman range with the reason of departure of the employee
// -------------------------------------------------------------------------------------------------
   ...
   public:
      ...
      class primary_key {
         ...
         public:
            ...
            primary_key(TReasonDeparture const& other) : iID(other._ID()) { }
