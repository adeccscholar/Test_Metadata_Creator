...
* Content: kind of salary as range value and base for calculations (fix, bonus, hourly, dayly, monthly, ...)
* Date: 22.04.2025 22:26:56,570  file created with adecc Scholar metadata generator
...
// - kind of salary as range value and base for calculations (fix, bonus, hourly, dayly, monthly, ...)
// -------------------------------------------------------------------------------------------------
class TSalaryType : virtual public myCorporate::TSimplePersonBase {
   ...
   public:
      ...
      using func_ty = std::function<bool(TSalaryType&&)>;
