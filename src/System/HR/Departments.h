...
* Date: 22.04.2025 22:26:55,803  file created with adecc Scholar metadata generator
...
class TDepartments : virtual public myCorporate::TSimplePersonBase {
   ...
   public:
      ...
      class primary_key {
         ...
         public:
            ...
            explicit primary_key(TDepartments const& other);
      ...
      using func_ty = std::function<bool(TDepartments&&)>;
   ...
   public:
      ...
      explicit TDepartments(primary_key const&);
