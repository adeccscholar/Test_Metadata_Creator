...
* Date: 22.04.2025 22:26:55,927  file created with adecc Scholar metadata generator
...
class TFamilyStatus : virtual public TSimplePersonBase {
   ...
   public:
      ...
      class primary_key {
         ...
         public:
            ...
            explicit primary_key(TFamilyStatus const& other);
      ...
      using func_ty = std::function<bool(TFamilyStatus&&)>;
   ...
   public:
      ...
      explicit TFamilyStatus(primary_key const&);
